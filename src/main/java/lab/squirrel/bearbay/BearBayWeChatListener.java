...
public class BearBayWeChatListener implements WeChatListener {
    ...
    @Override
    public void setup(SquirrelEndPoint endPoint) {
        endPoint.setToLog(true);

        String bucket = endPoint.getInitParameter(ConfigConst.S3BUCKET);

        DataStorage dataStorage;
        if (S3.equals(endPoint.getInitParameter(DATA_STORAGE))) {
